      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4">
        <div className="max-w-md w-full">
            ...
            <div className="p-8 rounded-2xl bg-white shadow">
              ...
              <div className="!mt-8">
                <button onClick={async()=>{await handleSignIn();window.location.assign("")}} type="button" className="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-hardBeige hover:bg-tooHardBeige transition-all duration-500 focus:outline-none">
                  Sign in
                </button>
              </div>
              <button onClick={async()=>{await GoogleSignUporIn();window.location.assign("")}} href="#" className="flex items-center justify-center px-6 py-3 mt-4 text-gray-900 transition-colors duration-300 border-hardBeige transform border rounded-lg  hover:bg-softBeige">
