      ...
      <div className="relative mx-auto max-w-md p-4 md:h-auto">
        <div className="relative rounded-lg bg-white p-4 text-center shadow  sm:p-5">
          ...
          <div className="flex items-center justify-center space-x-4">
            ...
            <button
              type="button"
              className="rounded-lg bg-red-700 px-3 py-2 text-center text-sm outline-none font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-700 transition-all duration-500"
              onClick={onDelete}
            >
