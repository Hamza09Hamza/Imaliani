...
const CatCard = ({product}) => {
        ...
        <div className="bg-white rounded-2xl p-5 cursor-pointer hover:-translate-y-2 transition-all relative">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mt-2">{product.descrpition}</p>
              <div className='flex justify-around items-center mt-4 '>
                      <h4 className="text-lg text-gray-800 font-bold ">AED {product.price}</h4>
                      <button className="flex items-center max-w-[40%]  rounded-full justify-center bg-hardBeige px-2 py-1 text-sm text-white  hover:bg-tooHardBeige transition-all duration-500">
