...
const Customized = () => {
    ...
    const handleFileChange = (event) => {
        ...
        return ( <>
      <div class="max-w-4xl mx-auto py-10 pb-20">
        <div class="text-center">
          <h2 class="text-3xl font-extrabold text-gray-800 inline-block border-b-[3px] border-gray-800 pb-1">Cutomized Gifts</h2>
        </div>
        ...
        <div class="mt-12">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                  <div>
                    <input type="text" placeholder="First name"
                      class="px-4 py-3 bg-white text-gray-800 w-full text-sm border-2 rounded-md focus:border-Beige outline-none" />
                  </div>
                  <div>
          ...
          <div class="grid md:grid-cols-3 gap-4 mt-12">
            <div>
              ...
              <h3 class="text-xl font-bold text-gray-800 mt-1">Gift's Details</h3>
            </div>
              ...
              <form>
                <div class="grid sm:grid-cols-2 gap-4">
                    <div class="max-w-sm mx-auto">
                        <textarea id="message" rows="4" class="px-16 py-3 bg-white text-gray-800 w-full text-sm border-2 rounded-md focus:border-Beige outline-none" placeholder="Describe the Gift wanted.."></textarea>
                    </div>
                    ...
                    <div className='flex justify-center items-center flex-col transition-all duration-500'>
                        ...
                        <label for="file-upload" class="cursor-pointer bg-hardBeige hover:bg-Beige text-white font-bold py-2 px-4 rounded transition-all duration-500">
                            Upload File
                        </label>
                        {fileName && (
