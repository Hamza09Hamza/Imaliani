...
const SlideCard = ({image,type,title ,description}) => {
        ...
        className='lg:max-w-[30%] xxs:w-[80%]  relative overflow-hidden '>
            ...
            <div  className={`bg-black transition-all duration-700 bg-opacity-60 absolute rounded-2xl w-[100%] h-[100%]  flex flex-col justify-center p-8 ${state ? "top-0" : "top-[100%]"}` }>
                                <div >
