  ...
  <div className="mx-auto max-w-screen-xl  text-center">
      ...
      <ul     className="flex flex-wrap xxs:flex-col justify-center items-center mb-6 text-gray-900 ">
          <li data-aos="fade-left"
              ...
              <a href="https://www.instagram.com/imaliani_craft_studio?igsh=dXFzdnhpeWFxdWxq" className="mr-4 hover:underline md:mr-6 ">Instagram : imaliani_craft_studio</a>
          </li>
          <li data-aos="fade-left"
                data-aos-duration="1500"
                data-aos-delay="200"
                ...
                data-aos-easing="ease-in-sine">
              <a href="https://www.tiktok.com/@imaliani_craft_studio" className="mr-4 hover:underline md:mr-6">Tiktok : imaliani_craft_studio</a>
          </li>
          <li data-aos="fade-left"
                data-aos-duration="1500"
                data-aos-delay="300"
