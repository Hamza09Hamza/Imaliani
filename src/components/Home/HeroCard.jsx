...
const HeroCard = ({ title , description , imageSrc }) => {
        ...
        <div className='flex mb-20 justify-center mid:flex-col-reverse mid:gap-4  items-center    '>
            <div className='flex items-center mid:max-w-[90%] justify-center relative lg:max-w-[40%]'>
            ...
            <div className='  flex flex-col h-[100%] justify-around items-center   '>
                <div></div>
                <h3 className='text-brown lg:text-3xl mid:text-lg font-black text-semiHeader text-wrap lg:pb-16 mid:pb-4 '>
                {title}
                </h3>
                <p className='text-hardBeige mid:text-xs mid:text-center mid:text-tooHardBeige mid:mb-4 lg:text-lg text-wrap max-w-[70%]'>
                    {description}                
                </p>
                <div></div>
